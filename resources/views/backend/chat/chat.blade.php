            ...
            <div class="sidebar-inner slimscroll">
                <div class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="#">#Video Responsive Survey</a>
                        </li>
                        <li>
                            <a href="#">#500rs</a>
                        </li>
                        ...
                        <li>
                            <a href="#"><span class="chat-avatar-sm user-img"><img src="{{asset('backend/assets/img/user.jpg')}}" alt="" class="rounded-circle"><span class="status online"></span></span> John Doe </a>
                        </li>
                        <li>
                            <a href="#"><span class="chat-avatar-sm user-img"><img src="{{asset('backend/assets/img/user.jpg')}}" alt="" class="rounded-circle"><span class="status offline"></span></span> Richard Miles</a>
                        </li>
                        <li>
                            <a href="#"><span class="chat-avatar-sm user-img"><img src="{{asset('backend/assets/img/user.jpg')}}" alt="" class="rounded-circle"><span class="status away"></span></span> John Smith</a>
                        </li>
                        <li class="active">
                            <a href="#"><span class="chat-avatar-sm user-img"><img src="{{asset('backend/assets/img/user.jpg')}}" alt="" class="rounded-circle"><span class="status online"></span></span> Jennifer</a>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <div class="navbar">
                                    <div class="user-details mr-auto">
                                        <div class="float-left user-img m-r-10">
                                            <a href="profile.html" title="Jennifer Robinson"><img src="{{asset('backend/assets/img/patient-thumb-02.jpg')}}" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
                                        </div>
                                                ...
                                                <div class="chat chat-left">
                                                    <div class="chat-avatar">
                                                        <a href="profile.html" class="avatar">
                                                            <img alt="Jennifer Robinson" src="{{asset('backend/assets/img/patient-thumb-02.jpg')}}" class="img-fluid rounded-circle">
                                                        </a>
                                                    </div>
                                                    <div class="chat-body">
                                                        <div class="chat-bubble">
                                                            ...
                                                            <div class="chat-content img-content">
                                                                <div class="chat-img-group clearfix">
                                                                    ...
                                                                    <a class="chat-img-attach" href="#">
                                                                        <img width="182" height="137" alt="" src="{{Asset('backend/assets/img/placeholder.jpg')}}">
                            ...
                            <div class="chat-footer">
                                <div class="message-bar">
                                    <div class="message-inner">
                                        <a class="link attach-icon" href="#" data-toggle="modal" data-target="#drag_files"><img src="{{asset('backend/assets/img/attachment.png')}}" alt=""></a>
