        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        {{-- Form Start --}}
                        <form action="{{ url('/admin/create-depertment/store') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status" id="department_active" value="1" checked>
                                    <label class="form-check-label" for="department_active">Active</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status" id="department_inactive" value="0">
