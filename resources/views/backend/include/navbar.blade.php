  <!-- Navbar Header -->
                ...
                <nav class="navbar navbar-header navbar-header-transparent navbar-expand-lg border-bottom px-5">
                                    ...
                                    <li>
                                        <div class="notif-scroll scrollbar-outer">
                                            <div class="notif-center">
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="{{ asset('backend/assets/img/profile2.jpg') }}"
                                                            alt="Img Profile" />
                                                    </div>
                                                    <div class="notif-content">
                                                        <span class="block">
...
<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4 px-5">
                        <div>
