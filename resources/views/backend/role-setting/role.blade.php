...
@section('content')
    <style>
        ...
        #roles-list li .role-action .action-circle {
            background: #eee;
            border-radius: 50%;
            display: inline-flex;
            align-items: center;
        ...
        #roles-list li .role-action .action-circle:hover {
            background: #2F4050;
            color: #fff;
        }
                ...
                <div class="settings-page">
                    ...
                    <div class="settings-sidebar">
                        <ul>
                            ...
                            <li class="active"><a href="{{ url('/admin/role') }}"><i class="fa fa-key mr-2"></i> Roles &
                                    Permissions</a></li>
                            <li><a href="{{url('/admin/user/create')}}"><i class="fa fa-user mr-2"></i> Create Users</a></li>
                    ...
                    <div class="settings-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-md-4 col-lg-4 col-xl-3">
                                <a href="{{ url('/admin/role-add') }}" class="btn btn-primary btn-block mb-3"><i
                                        class="fa fa-plus"></i> Add Role</a>
                                <ul id="roles-list">
                                    @foreach ($roles as $role)
                                        <li class="{{ $loop->first ? 'active' : '' }}" data-role-id="{{ $role->id }}"
                                            ...
                                            <span class="role-action">
                                                ...
                                                <a href="{{ url('/admin/role-delete/' . $role->id) }}"
                                                    ...
                                                    <span class="action-circle delete-btn"><i
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-9">
                                <h6 class="card-title m-b-20" id="role-title">
                                    {{ $roles->first()->name ?? 'Administrator' }} Module Access</h6>
                                        ...
                                        @foreach ($modules as $module)
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <div class="material-switch float-right">
                                                    <input id="{{ Str::slug($module) }}_module" type="checkbox"
                                                        {{ $hasPermission ? 'checked' : '' }}>
                                                    <label for="{{ Str::slug($module) }}_module"
                                                        class="badge-success"></label>
                                                </div>
                                            </li>
                                        @endforeach
                                    </ul>
