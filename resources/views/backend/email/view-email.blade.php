            ...
            <div class="sidebar-inner slimscroll">
                <div class="sidebar-menu">
                    <ul>
                        ...
                        <li class="menu-title"><a href="{{url('/admin/compose-email')}}" class="btn btn-primary btn-block">Compose</a></li>
                        <li class="active">
                            <a href="{{url('/admin/ixbox-email')}}">Inbox <span class="mail-count">(21)</span></a>
                        </li>
                        <li>
                            <a href="#">Starred</a>
                        </li>
                        ...
                        <div class="card-box">
                                ...
                                <div class="mailview-header">
                                    ...
                                    <div class="sender-info">
                                        <div class="sender-img">
                                            <img width="40" alt="" src="{{asset('backend/assets/img/user.jpg')}}" class="rounded-circle">
                                        </div>
                            ...
                            <div class="mail-attachments">
                                ...
                                <ul class="attachments clearfix text-center">
                                    ...
                                    <li>
                                        <div class="attach-file"><img src="{{asset('backend/assets/img/placeholder.jpg')}}" alt="Attachment"></div>
                                        <div class="attach-info">
